...
namespace E_Commerces.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreatedAt,UpdatedAt,Status,TotalPrice,VatRate,VatCharge,Promotion,FinalPrice")] Invoice invoice)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Orders, "Id", "Id", invoice.Id);
            return View(invoice);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreatedAt,UpdatedAt,Status,TotalPrice,VatRate,VatCharge,Promotion,FinalPrice")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
